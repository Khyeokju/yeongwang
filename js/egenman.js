...
function preloadNext(questionIdxZeroBased) {
  const nextNum = questionIdxZeroBased + 2; // 현재가 0이면 다음은 2 (man2)
  if (nextNum <= 10) {
...
function changeBackgroundImage(questionNumber) {
  ...
  requestAnimationFrame(() => {
    ...
    document.documentElement.style.backgroundImage = `url("../images/man${questionNumber}.png")`;
...
function handleAnswer(selectedIndex) {
  // 남자 에겐 규칙: 1,2,3,4,6,8,10 = yes가 에겐 / 5,7,9 = no가 에겐
